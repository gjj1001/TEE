...
public class ObserverPopupWindow<T> implements OnClickListener {
	Context context;
	...
	public ObserverPopupWindow(ViewPager viewpager) {
		mViewpager = viewpager;
	}
	
	public ObserverPopupWindow(Context context, String uname, Object obj, SharedPreferences share, 
			BaseAdapter adapter, List<Observer> list) {
	...
	public void onClick(View v) {
		...
		case 0://删除
			...
			String urlString = String.format(Urls.USER_OBSERVER+"?uname=%s&username=%s&del=%s",
					uname, observer.getUsername(), "true");
			new DeleteObserverTask().execute(urlString);
			break;
		}
//		mViewpager.setCurrentItem(Integer.parseInt(v.getTag().toString()));
	...
	class DeleteObserverTask extends AsyncTask<String, Void, String> {
