...
public class ConversationPopupWindow<T> implements OnClickListener {
	Context context;
	...
	public ConversationPopupWindow(ViewPager viewpager) {
		mViewpager = viewpager;
	}
	
	public ConversationPopupWindow(Context context, String uname, Object obj, SharedPreferences share, 
			BaseAdapter adapter, List<Message> list) {
	...
	public void onClick(View v) {
		...
		case 0://删除
			...
			String urlString = String.format(Urls.USER_MESSAGE+"?send_person=%s&reply_person=%s&send_date=%s&del=%s",
					message.getSend_person(), uname, message.getSend_date(), "true");
			new DeleteMessageTask().execute(urlString);
			break;
		}
