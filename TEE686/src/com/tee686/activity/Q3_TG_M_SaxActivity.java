...
public class Q3_TG_M_SaxActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ImageButton display = (ImageButton)findViewById(R.id.q3_tg_m_sax_btn);
		final ImageView iv = (ImageView)findViewById(R.id.q3_tg_m_sax_iv);
		final TextView tv = (TextView)findViewById(R.id.q3_tg_m_sax_tv);
        final ImageButton ib1 = (ImageButton)findViewById(R.id.q3_tg_m_sax_ib1);
		...
		display.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(textStr.equals("显示所有结构")) {
					tv.setText("隐藏所有结构");
					iv.setImageResource(R.drawable.q3_tg_m_sax_show);
				}
				else if(textStr.equals("隐藏所有结构")) {
					tv.setText("显示所有结构");
					iv.setImageResource(R.drawable.q3_tg_m_sax);
				}
			}			
		});
