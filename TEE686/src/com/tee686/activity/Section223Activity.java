...
public class Section223Activity extends Activity {
		...
		public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2,
			...
			switch(arg2){
				...
				+ arg0.getItemAtPosition(arg2).toString(), Toast.LENGTH_LONG).show();
					intent = new Intent(Section223Activity.this, Section686Activity.class); 
			        startActivity(intent);
					break;
				case 1:
					Toast.makeText(arg0.getContext(),"You choose " 
				+ arg0.getItemAtPosition(arg2).toString(), Toast.LENGTH_LONG).show();
					intent = new Intent(Section223Activity.this, Section6641Activity.class); 
			        startActivity(intent);
					break;
				case 2:
					Toast.makeText(arg0.getContext(),"You choose " 
				+ arg0.getItemAtPosition(arg2).toString(), Toast.LENGTH_LONG).show();
					intent = new Intent(Section223Activity.this, Section2345Activity.class); 
			        startActivity(intent);
					break;
				case 3:
					Toast.makeText(arg0.getContext(),"You choose " 
				+ arg0.getItemAtPosition(arg2).toString(), Toast.LENGTH_LONG).show();
					//intent = new Intent(Section223Activity.this, Section223Activity.class); 
			        //startActivity(intent);
					break;
				default:
					break;
