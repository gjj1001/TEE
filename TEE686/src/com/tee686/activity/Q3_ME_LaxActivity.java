...
public class Q3_ME_LaxActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ImageButton display = (ImageButton)findViewById(R.id.q3_me_lax_btn);
		final ImageView iv = (ImageView)findViewById(R.id.q3_me_lax_iv);
		final TextView tv = (TextView)findViewById(R.id.q3_me_lax_tv);
        final ImageButton ib1 = (ImageButton)findViewById(R.id.q3_me_lax_ib1);
		...
		display.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(textStr.equals("显示所有结构")) {
					tv.setText("隐藏所有结构");
					iv.setImageResource(R.drawable.q3_me_lax_show);
				}
				else if(textStr.equals("隐藏所有结构")) {
					tv.setText("显示所有结构");
					iv.setImageResource(R.drawable.q3_me_lax);
				}
			}			
		});
