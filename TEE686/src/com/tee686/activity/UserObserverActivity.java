...
public class UserObserverActivity extends BaseActivity {
...
//				mAdapter.appendToList(result);		
				...
				lv.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						IntentUtil.startActivity(UserObserverActivity.this, UserInfoActivity.class,
				...
				if(share.getString(UserLoginActivity.UID, "").equals(intent.getStringExtra("uname"))) {
					lv.setOnItemLongClickListener(new OnItemLongClickListener() {
						...
						public boolean onItemLongClick(AdapterView<?> parent,
							...
							tabs.add("删除");
							ObserverPopupWindow<String> util = new ObserverPopupWindow<String>(UserObserverActivity.this, 
...
>>>>>>> 3b3581198e1fec9c4dfce8620d803bfe29827f12
	...
	class DataAsyncTask extends AsyncTask<String, Void, List<Observer>> {
		...
		protected List<Observer> doInBackground(String... params) {			
			...
			try {				
				result = HttpUtils.getByHttpClient(UserObserverActivity.this, params[0]);					
...
//				result.clear();
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			 ...
			 */
			viewHolder.tvUsername.setText(observer.getUsername());
			...
			synchronized (viewHolder) {
				if (!"".equals(observer.getHeadimage())) {
					...
					ImageUtil.setThumbnailView(observer.getHeadimage(),
							viewHolder.ivHeadimage, UserObserverActivity.this,
							callback1, true);
				}
			}
			/*
